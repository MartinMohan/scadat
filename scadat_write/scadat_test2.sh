...
unset TANGO_HOST
assertgrep.sh "scadat -v" "scadat_version"
export TANGO_HOST="InvalidHostName:1234"
assertequal.sh "scadat -l" "InvalidHostName:1234 openDB <class 'socket.gaierror'>" stderr
...
assertequal.sh "scadat -w bad/device/name" "Cannot read device bad/device/name" stderr
assertgrep.sh "scadat -w" "scadat: error: argument -w: expected at least one argument" stderr
assertequal.sh "scadat -w aa/bb/cc" "Cannot read device aa/bb/cc" stderr
assertequal.sh "scadat -w AABBCC" "stderr: Invalid name AABBCC (expected aa/bb/cc/<dd>)" stderr
assertequal.sh "scadat -w baddevicename" "stderr: Invalid name baddevicename (expected aa/bb/cc/<dd>)" stderr
...
#scadat -w
assertequal.sh "scadat -w sys/tg_test/1 | grep Status" "sys/tg_test/1/Status"
assertequal.sh "scadat -w sys/tg_test/1 -v | grep Status" "sys/tg_test/1/Status <attr_ro>"
assertgrep.sh "scadat -w sys/tg_test/1 | grep long_scalar_rww" "sys/tg_test/1/long_scalar_rww"
assertgrep.sh "scadat -w sys/tg_test/1 | grep long_scalar_w" "sys/tg_test/1/long_scalar_w"

# Write/Read Attributes
assertgrep.sh "scadat -w sys/tg_test/1" "sys/tg_test/1"
assertequal.sh "scadat -w sys/tg_test/1 123" "Usage: scadat -w aa/bb/cc/dd 123" stderr
assertequal.sh "scadat -w sys/tg_test/1 123" "Usage: scadat -w aa/bb/cc/dd 123" stderr
assertgrep.sh "scadat -w bad/device/name sys/tg_test/1" "sys/tg_test/1" stderr
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w" "sys/tg_test/1/long_scalar_w"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w -v" "sys/tg_test/1/long_scalar_w <attr_w>"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w 4321" "sys/tg_test/1/long_scalar_w->4321"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w -vv" "sys/tg_test/1/long_scalar_w 4321"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w 1234" "sys/tg_test/1/long_scalar_w->1234"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w -vv" "sys/tg_test/1/long_scalar_w 1234"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w" "sys/tg_test/1/long_scalar_w"
assertequal.sh "scadat -w sys/tg_test/1/long_scalar_w -v" "sys/tg_test/1/long_scalar_w <attr_w>"
assertequal.sh "scadat -w sys/tg_test/1/string_scalar 'my string 123'" "sys/tg_test/1/string_scalar->my string 123"
assertequal.sh "scadat -w sys/tg_test/1/string_scalar" "sys/tg_test/1/string_scalar"
assertequal.sh "scadat -w sys/tg_test/1/string_scalar -v" "sys/tg_test/1/string_scalar <attr_w>"
assertgrep.sh "scadat -w sys/tg_test/1/string_scalar -vv" "sys/tg_test/1/string_scalar my string 123"
assertequal.sh "scadat -w sys/tg_test/1 | grep ulong_image_ro" "sys/tg_test/1/ulong_image_ro"
assertgrep.sh "scadat -w sys/tg_test/1" "sys/tg_test/1/Status"
...
#if ! $(python2 -c "import PyTango" &> /dev/null); then
python2 -c "import PyTango" > /dev/null 2>&1
if [ "$?" != "$PASS" ] ; then
...
#python3 -c "import PyTango" &> /dev/null - bash format
python3 -c "import PyTango" > /dev/null 2>&1
if [ "$?" != "$PASS" ] ; then
