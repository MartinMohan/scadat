...
scadat_version="0.5.0"
#scadat_version="2021_01" # Use date for version control
import os,sys,re,argparse,socket,string,os
#import PyTango
try:
    import PyTango
except ImportError:
    print >> sys.stderr, "Missing PyTango: 'sudo apt-get install python-pytango'"
    sys.exit(1)
...
#            print("scadat_version "+str(scadat_version))
